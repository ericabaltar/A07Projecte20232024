...
public class HealthBehaviour : MonoBehaviour
{
    ...
    public Text damageText; // Referencia al texto que muestra el dano recibido
    ...
    private void UpdateHealthBarColor()
    {
        if (healthBar != null)
        {
            ...
            // Cambiar el color de la barra de vida segun la cantidad de vida restante
            if (healthRatio > 0.5f)
    ...
    private void ShowDamageText()
    {
        if (damageText != null)
        {
            ...
            // Cambiar el color del texto de dano a rojo
            damageText.color = Color.red;
        }
    }
    // Método para recuperar la salud al máximo al recoger un corazón
