...
public class HealthBehaviour : MonoBehaviour
{
    ...
    public Text damageText; // Referencia al texto que muestra el da�o recibido
    ...
    private void UpdateHealthBarColor()
    {
        if (healthBar != null)
        {
            ...
            // Cambiar el color de la barra de vida seg�n la cantidad de vida restante
            if (healthRatio > 0.5f)
    ...
    private void ShowDamageText()
    {
        if (damageText != null)
        {
            ...
            // Cambiar el color del texto de da�o a rojo
